...
if APC==1
    ...
    [U,S,R]=svdk(xpc,kpc);
    pc=xpc*R;PCA=pc;npc=size(PCA,2);clear pc U S xy kpc xpc
end
...
Marker=marker;chromosome=chrgl;position=poslm;p_f=pr;beta=b(npc+2:end);sebeta=SEb(npc+1:end);r2=r2lz;
