function [b,effect,plm,seblm,ft,lmbx,lm,r2lm] =ISR(x,y,impute,yname,alfa,glm,ept0)
%MLLM FOR GWAS
...
plm=ones(p,1);effect=zeros(p,1);r2lm=zeros(p,1);seblm=zeros(p,1);ft=zeros(p,1);
